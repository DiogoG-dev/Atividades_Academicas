...
public class Main {
    public static void main(String[] args){
        Santander santander = new Santander("SantanderBS",
                "Diogo Gabriel",
                "Brasil",
                "Avenida Coronel Nicodemos, 100, Centro",
                2,
                "BRL");
        ...
        CreditCard creditCard = new CreditCard("Diogo G R Santos",
                santander,
                1351.39);

        Visa visa = new Visa("Diogo G R Santos",
                santander,
                1351.39);

        MasterCard masterCard = new MasterCard("Diogo G R Santos",
                santander,
                1351.39);
        ...
        jpMorgan.createInsurancePolicy("Diogo Gabriel", 19);
